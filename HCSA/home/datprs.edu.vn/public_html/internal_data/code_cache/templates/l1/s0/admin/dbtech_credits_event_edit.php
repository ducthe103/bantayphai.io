<?php
// FROM HASH: 679582970eae0e8b0fe6c4a548a0b392
...
Use 1 to apply this event every time this event trigger occurs.',
		...
		'explain' => 'After this event has occurred this many times, the event trigger will occur without triggering this event again.<br />
0 = no maximum.',
	)) . '
...
', array(
		'action' => $__templater->fn('link', array('dbtech-credits/events/save', $__vars['event'], ), false),
		'class' => 'block',
		'ajax' => 'true',
	));
