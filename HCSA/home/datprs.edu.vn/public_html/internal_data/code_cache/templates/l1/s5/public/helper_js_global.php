<?php
// FROM HASH: 274b4faf6849169f2e951290cdb917ad
return array('macros' => array('head' => function($__templater, array $__arguments, array $__vars)
{
	...
	';
	if ($__templater->fn('property', array('dt_favicon', ), false)) {
		$__finalCompiled .= '<link href="' . $__templater->fn('property', array('dt_favicon', ), true) . '" rel="icon" type="image/x-icon" />';
	}
	$__finalCompiled .= '
	...
	';
	if ($__templater->fn('property', array('dt_google_font', ), false)) {
		$__finalCompiled .= '
		<link href=\'//fonts.googleapis.com/css?family=' . $__templater->fn('property', array('dt_google_font', ), true) . '\' rel=\'stylesheet\' type=\'text/css\'>
	';
	}
	$__finalCompiled .= '
...
' . $__templater->callMacro('thspotify_spotify_macros', 'global_js', array(), $__vars) . '<script>jQuery.extend(XF.phrases, {
		...
		brms_update:         "' . $__templater->filter('Update', array(array('escape', array('js', )),), true) . '",
		brms_review:         "' . $__templater->filter('Review', array(array('escape', array('js', )),), true) . '",
		brms_rating: "' . $__templater->filter('Rating', array(array('escape', array('js', )),), true) . '",
		brms_forum:          "' . $__templater->filter('Forum', array(array('escape', array('js', )),), true) . '",
		brms_views:          "' . $__templater->filter('Views', array(array('escape', array('js', )),), true) . '",
		brms_replies:        "' . $__templater->filter('Replies', array(array('escape', array('js', )),), true) . '",
		brms_likes:          "' . $__templater->filter('Likes', array(array('escape', array('js', )),), true) . '",
});
</script>
	<script>
