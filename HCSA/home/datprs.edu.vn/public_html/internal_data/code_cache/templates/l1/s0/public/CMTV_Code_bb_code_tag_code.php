...
<div class="bbCodeBlock bbCodeBlock--screenLimited bbCodeBlock--code ' . ($__vars['language'] ? ('language-' . $__templater->escape($__vars['language'])) : 'noLang') . ' ' . $__templater->escape($__vars['options']['class']) . '"
	...
	<div class="bbCodeBlock-header">
		<div class="bbCodeBlock-title">
			<span title="' . ($__vars['options']['title'] ? ($__templater->escape($__vars['config']['phrase']) ?: 'Code') : '') . '">
				' . (($__templater->escape($__vars['options']['title']) ?: $__templater->escape($__vars['config']['phrase'])) ?: 'Code') . $__templater->escape($__vars['xf']['language']['label_separator']) . '
			</span>
		</div>
