		...
		if ($__templater->isTraversable($__vars['items'])) {
			...
			';
				...
				<div class="listBlock itemDetail itemDetailDate">
					<a class="paint" href="' . $__templater->fn('link', array('threads', $__vars['thread'], ), true) . '" title="">' . 'Views' . ': ' . $__templater->filter($__vars['thread']['view_count'], array(array('number', array()),), true) . '</a>
				</div>
