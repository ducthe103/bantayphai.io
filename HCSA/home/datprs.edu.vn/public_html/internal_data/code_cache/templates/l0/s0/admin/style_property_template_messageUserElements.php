...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	array(
		'name' => $__vars['formBaseKey'] . '[thspotify]',
		'selected' => $__vars['property']['property_value']['thspotify'],
		'label' => '
	...
	array(
		'name' => $__vars['formBaseKey'] . '[th_spotify_playback]',
		'selected' => $__vars['property']['property_value']['th_spotify_playback'],
		'label' => '
		' . 'Spotify playback details' . '
	',
		'_type' => 'option',
	)), array(
