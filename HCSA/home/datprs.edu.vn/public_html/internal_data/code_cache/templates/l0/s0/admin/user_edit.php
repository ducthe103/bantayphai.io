	...
	if ($__vars['user']['user_id']) {
		$__compilerTemp8 .= '
					<a class="tabs-tab" role="tab" tabindex="0"
						...
						href="' . $__templater->fn('link', array('users/edit', $__vars['user'], ), true) . '#user-extras">' . 'Extra' . '</a>
					<a class="tabs-tab" role="tab" tabindex="0"
						id="user-ips"
						aria-controls="user-ips"
						href="' . $__templater->fn('link', array('users/edit', $__vars['user'], ), true) . '#user-ips">' . 'IP addresses' . '</a>
					<a class="tabs-tab" role="tab" tabindex="0"
						id="user-changes"
						aria-controls="user-changes"
						href="' . $__templater->fn('link', array('users/edit', $__vars['user'], ), true) . '#user-changes">' . 'Change log' . '</a>
				';
	}
	$__compilerTemp9 = '';
		...
		<h2 class="block-tabHeader tabs hScroller" data-xf-init="tabs h-scroller" data-state="replace" role="tablist">
			<span class="hScroller-scroll">
				...
				<a class="tabs-tab is-active" role="tab" tabindex="0"
					...
					href="' . $__templater->fn('link', array('users/edit', $__vars['user'], ), true) . '#user-details">' . 'User details' . '</a>
				' . $__compilerTemp8 . '
