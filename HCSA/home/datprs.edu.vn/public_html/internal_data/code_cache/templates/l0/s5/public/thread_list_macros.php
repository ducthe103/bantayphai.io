<?php
// FROM HASH: fbd2b728be470aeb74f4387df6ac6a80
return array('macros' => array('item' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__templater->fn('property', array('dt_discussion_online', ), false)) {
		$__finalCompiled .= '
					';
		if ($__templater->method($__vars['thread']['User'], 'isOnline', array())) {
			$__finalCompiled .= '
							<span class="forum-avatar-online" data-xf-init="tooltip" title="' . $__templater->filter('Online now', array(array('for_attr', array()),), true) . '"></span>
						';
		} else if ($__templater->fn('property', array('dt_offline_indicator', ), false)) {
			$__finalCompiled .= '
...
';
	if ($__templater->fn('property', array('discussionList_lastpost_avatar', ), false)) {
		$__finalCompiled .= '
';
		if ($__vars['thread']['last_post_user_id']) {
			$__finalCompiled .= '
	';
			$__templater->includeCss('reme_core.less');
			$__finalCompiled .= '
	<div class="lastpost--avatar">
		' . $__templater->fn('avatar', array(array('user_id' => $__vars['thread']['last_post_user_id'], ), 'xs', false, array(
	...
	$__finalCompiled .= '
			...
			<div class="contentRow-minor contentRow-minor--hideLinks">
				<ul class="listInline listInline--bullet">
					<li>' . 'Latest: ' . $__templater->fn('username_link', array($__vars['thread']['LastPoster'], ), true) . '' . '</li>
