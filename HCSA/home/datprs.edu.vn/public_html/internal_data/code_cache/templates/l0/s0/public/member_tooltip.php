...
<div class="tooltip-content-inner">
	...
	$__finalCompiled .= '
				...
				' . $__templater->callMacro('ah_gamerprofiles_macros', 'ah_gamerprofiles_member_tooltip', array(
		'user' => $__vars['user'],
	), $__vars) . '
...
' . $__templater->callMacro('thspotify_spotify_macros', 'member_tooltip', array(
		'user' => $__vars['user'],
	), $__vars) . '
			</div>
		</div>
