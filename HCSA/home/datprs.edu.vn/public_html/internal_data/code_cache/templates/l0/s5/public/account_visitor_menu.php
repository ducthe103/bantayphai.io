...
';
	...
	if ($__templater->fn('property', array('dt_condense_visito_tabs', ), false)) {
		$__compilerTemp3 .= '
			<li><a href="' . $__templater->fn('link', array('conversations', ), true) . '" class="menu-linkRow js-badge--conversations badgeContainer' . ($__vars['xf']['visitor']['conversations_unread'] ? ' badgeContainer--highlighted' : '') . '" data-badge="' . $__templater->filter($__vars['xf']['visitor']['conversations_unread'], array(array('number', array()),), true) . '">' . 'Conversations' . '</a></li>
			<li><a href="' . $__templater->fn('link', array('account/alerts', ), true) . '" class="menu-linkRow js-badge--alerts badgeContainer' . ($__vars['xf']['visitor']['alerts_unread'] ? ' badgeContainer--highlighted' : '') . '" data-badge="' . $__templater->filter($__vars['xf']['visitor']['alerts_unread'], array(array('number', array()),), true) . '">' . 'Alerts' . '</a></li>
		';
	}
	$__compilerTemp4 = '';
