...
';
	...
	<dl class="pairs pairs--rows pairs--rows--centered fauxBlockLink">
		...
		<dd>
			<a href="' . $__templater->fn('link', array('dbtech-credits/currency', $__vars['currency'], array('user_id' => $__vars['user']['user_id'], ), ), true) . '" data-xf-click="overlay" class="fauxBlockLink-blockLink u-concealed">
