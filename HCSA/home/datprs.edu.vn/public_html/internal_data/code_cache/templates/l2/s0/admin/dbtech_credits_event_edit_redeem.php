...
' . $__templater->formDateInputRow(array(
		...
		'value' => ($__vars['event']['settings']['redeem_startdate'] ? $__templater->fn('date', array($__vars['event']['settings']['redeem_startdate'], 'picker', ), false) : $__templater->fn('date', array($__vars['xf']['time'], 'picker', ), false)),
	), array(
		'label' => 'Ngày gửi',
...
' . $__templater->formDateInputRow(array(
		...
		'value' => ($__vars['event']['settings']['redeem_enddate'] ? $__templater->fn('date', array($__vars['event']['settings']['redeem_enddate'], 'picker', ), false) : $__templater->fn('date', array($__vars['xf']['time'], 'picker', ), false)),
	), array(
		'label' => 'End Date',
