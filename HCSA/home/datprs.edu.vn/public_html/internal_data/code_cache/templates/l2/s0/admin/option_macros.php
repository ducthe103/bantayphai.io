...
return array('macros' => array('option_row' => function($__templater, array $__arguments, array $__vars)
{
	...
	';
		...
		';
			...
			$__finalCompiled .= '
			';
			$__vars['users'] = $__templater->method($__templater->method($__vars['xf']['app']['em'], 'getRepository', array('XF:User', )), 'getUsersByIdsOrdered', array(($__templater->fn('is_array', array($__vars['option']['option_value'], ), false) ? $__vars['option']['option_value'] : array()), ));
			$__finalCompiled .= '
			';
