...
' . $__templater->callMacro('approval_queue_macros', 'item_message_type', array(
		...
		'headerPhraseHtml' => 'Thread <a href="' . $__templater->fn('link', array('threads', $__vars['content'], ), false) . '">' . $__vars['content']['title'] . '</a> posted in forum <a href="' . $__templater->fn('link', array('forums', $__vars['content']['Forum'], ), false) . '">' . $__vars['content']['Forum']['title'] . '</a>',
	), $__vars);
