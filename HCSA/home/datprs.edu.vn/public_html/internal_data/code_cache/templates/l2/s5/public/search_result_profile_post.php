	...
	<div class="contentRow ' . ((!$__templater->method($__vars['profilePost'], 'isVisible', array())) ? 'is-deleted' : '') . '">
		...
		<div class="contentRow-main">
			<h3 class="contentRow-title">
				<a href="' . $__templater->fn('link', array('profile-posts', $__vars['profilePost'], ), true) . '">' . $__templater->fn('snippet', array($__vars['profilePost']['message'], 100, array('term' => $__vars['options']['term'], 'stripQuote' => true, 'fromStart' => true, 'hideUnviewable' => false, ), ), true) . '</a>
			</h3>
