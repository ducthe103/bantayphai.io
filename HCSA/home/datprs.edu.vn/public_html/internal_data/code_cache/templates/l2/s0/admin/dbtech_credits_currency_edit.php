<?php
// FROM HASH: b5d48c6f6bca07cd0a02ee4cf99c3a8e
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	if ($__templater->method($__vars['currency'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('dbtech_credits_add_currency');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
...
If this column does not exist on the above table, it will be added.',
		...
		'value' => '0',
		'label' => 'Reset to 0 when negative',
		'_type' => 'option',
	),
	array(
		'value' => '1',
...
', array(
		'action' => $__templater->fn('link', array('dbtech-credits/currencies/save', $__vars['currency'], ), false),
		'class' => 'block',
		'ajax' => 'true',
	));
