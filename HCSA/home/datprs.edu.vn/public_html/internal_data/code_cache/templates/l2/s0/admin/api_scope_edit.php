...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->fn('link', array('api-scopes/delete', $__vars['scope'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
' . $__templater->form('
	<div class="block-container">
		...
		'maxlength' => $__templater->fn('max_length', array($__vars['scope'], 'api_scope_id', ), false),
		'dir' => 'ltr',
	), array(
		'label' => 'Scope ID',
	)) . '
...
', array(
		'action' => $__templater->fn('link', array('api-scopes/save', $__vars['scope'], ), false),
		'class' => 'block',
		'ajax' => 'true',
	));
