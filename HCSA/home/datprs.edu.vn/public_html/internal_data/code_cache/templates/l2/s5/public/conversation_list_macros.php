<?php
// FROM HASH: 171500adadc8397f6ae19c5940fba099
return array('macros' => array('item' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__finalCompiled .= '
			...
			<a href="' . $__templater->fn('link', array('conversations/unread', $__vars['userConv'], ), true) . '" class="structItem-title" data-tp-primary="on">' . $__templater->escape($__vars['userConv']['title']) . '</a>
