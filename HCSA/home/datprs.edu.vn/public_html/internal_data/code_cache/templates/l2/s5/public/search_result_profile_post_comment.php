	...
	<div class="contentRow ' . ((!$__templater->method($__vars['comment'], 'isVisible', array())) ? 'is-deleted' : '') . '">
		...
		<div class="contentRow-main">
			<h3 class="contentRow-title">
				<a href="' . $__templater->fn('link', array('profile-posts/comments', $__vars['comment'], ), true) . '">' . $__templater->fn('snippet', array($__vars['comment']['message'], 100, array('term' => $__vars['options']['term'], 'stripQuote' => true, 'fromStart' => true, 'hideUnviewable' => false, ), ), true) . '</a>
			</h3>
