<?php
// FROM HASH: fa0004399f09a25adbb08e34285c4065
...
<div class="block" data-xf-init="' . ($__vars['canInlineMod'] ? 'inline-mod' : '') . '" data-type="thread" data-href="' . $__templater->fn('link', array('inline-mod', ), true) . '">
	...
	$__finalCompiled .= '
	';
	$__vars['sortOrders'] = array('last_post_date' => 'Bài viết cuối', 'post_date' => 'Bài viết đầu tiên', 'title' => 'Tiêu đề', 'reply_count' => 'Trả lời', 'view_count' => 'Lượt xem', 'first_post_reaction_score' => 'First message reaction score', );
	$__finalCompiled .= '
				...
				$__finalCompiled .= '
								<div class="structItem structItem--note">
									<div class="structItem-cell">
										<a href="' . $__templater->fn('link', array('forums', $__vars['forum'], array('page' => $__vars['page'], 'no_date_limit' => 1, ) + $__vars['filters'], ), true) . '">
											' . 'Hiển thị mục cũ hơn' . '
										</a>
									</div>
								</div>
