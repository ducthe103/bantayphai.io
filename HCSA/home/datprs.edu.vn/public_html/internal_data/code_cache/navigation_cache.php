...
return function($__templater, $__selectedNav, array $__vars)
{
	...
	if (($__vars['xf']['options']['siropuShoutboxNavigation'] AND ($__templater->method($__vars['xf']['visitor'], 'canViewSiropuShoutbox', array()) AND ($__templater->method($__vars['xf']['visitor'], 'hasRequiredAge', array()) AND (!$__templater->method($__vars['xf']['visitor'], 'isBannedSiropuShoutbox', array())))))) {
		$__navTemp = [
		'title' => \XF::phrase('nav.siropuShoutbox'),
		'href' => $__templater->fn('link', array('shoutbox', ), false),
		'attributes' => [],
	];
		if ($__navTemp) {
			$__tree['siropuShoutbox'] = $__navTemp;
			$__flat['siropuShoutbox'] =& $__tree['siropuShoutbox'];
			if (empty($__tree['siropuShoutbox']['children'])) { $__tree['siropuShoutbox']['children'] = []; }

			if ($__templater->method($__vars['xf']['visitor'], 'canViewSiropuShoutboxArchive', array())) {
				$__navTemp = [
		'title' => \XF::phrase('nav.siropuShoutboxArchive'),
		'href' => $__templater->fn('link', array('shoutbox/archive', ), false),
		'attributes' => [],
	];
				if ($__navTemp) {
					$__tree['siropuShoutbox']['children']['siropuShoutboxArchive'] = $__navTemp;
					$__flat['siropuShoutboxArchive'] =& $__tree['siropuShoutbox']['children']['siropuShoutboxArchive'];
				}
			}
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canViewDbtechCredits', array())) {
		...
		'href' => $__templater->fn('link', array('dbtech-credits', ), false),
		'attributes' => [],
	];
		if ($__navTemp) {
