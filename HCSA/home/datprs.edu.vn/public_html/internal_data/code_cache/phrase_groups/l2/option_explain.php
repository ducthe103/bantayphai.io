<?php
return array (
  'option_explain.CMTV_Code_backComp' => 'If enabled, code blocks from old addon versions <code>[code=title|lang]...[/code]</code> will be treated as <code>[code lang="lang" title="title"]...[/code]</code>.',
  'option_explain.CMTV_Code_commonLanguages' => 'The languages defined here will be shown in "Common languages" block in "Insert code" editor dialog.',
  'option_explain.CMTV_Code_defaultCodeLanguage' => 'This language will be selected by default in "Inert code" editor dialog.',
  'option_explain.CMTV_Code_lineHighlight_enabled' => 'If enabled, users will be able to highlight specific lines and/or line ranges in code blocks. <a href="https://prismjs.com/plugins/line-highlight/" target="_blank">Plugin page</a>',
  'option_explain.CMTV_Code_lineNumbers_enabled' => 'If enabled, shows line number at the beginning of lines in code blocks. <a href="https://prismjs.com/plugins/line-numbers/" target="_blank">Plugin page</a>',
...
<b>This feature does not require the Facebook application ID or application secret fields to be completed.</b>',
  ...
  'option_explain.siropuShoutboxArhiveMessagesPerPage' => 'The maximum number of messages to display per page.',
  ...
  'option_explain.siropuShoutboxEmojiList' => 'If checked, users can search and choose emojis from a list.',
  ...
  'option_explain.siropuShoutboxRefreshTimeout' => 'This option will stop refresh interval if the user is not active for more than x minutes. Set to 0 to disable.',
  ...
  'option_explain.siropuShoutboxUserTag' => 'This option will add an @ button before the username for quick user tagging.',
  ...
  'option_explain.thspotify_pollRate' => 'The poll rate to update current track (in milliseconds)',
