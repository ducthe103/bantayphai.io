...
class Currency extends AbstractController
{
     ...
     * @return \XF\Mvc\Reply\View
     */
    protected function currencyAddEdit(\DBTech\Credits\Entity\Currency $currency)
	{
		$viewParams = [
			'currency' => $currency,
		];
	 ...
	 * @return FormAction
	 */
	protected function currencySaveProcess(\DBTech\Credits\Entity\Currency $currency)
	{
