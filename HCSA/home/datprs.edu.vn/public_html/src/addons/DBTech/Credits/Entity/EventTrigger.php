...
class EventTrigger extends Entity
{
	 ...
	 * @throws \Exception
	 */
	public function getHandler($throw = true)
	{
	 ...
	 * @param boolean|string $fieldName [description]
	 * @param array $columnOptions [description]
	 * @return boolean
	 */
	protected function verifyMultiplierLabel(&$label, $fieldName = false, array $columnOptions = [])
	{
		if (!$label || $label == "''")
		{
